      ...
      wx.uploadFile({
        ...
        success(res) {
          ...
          if (red.code == 1) {
            ...
            let uinfo = wx.getStorageSync("user");
            uinfo.avatar_url = 'https://picture-cr45mes.oss-cn-shenzhen.aliyuncs.com/img/202212310747329.png';
            // uinfo.avatar_url = red.data.url;
            wx.setStorageSync("user", uinfo)
            _this.setData({
              'msg.avatar_url': 'https://picture-cr45mes.oss-cn-shenzhen.aliyuncs.com/img/202212310747329.png'
