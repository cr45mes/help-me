...
Page({
  ...
  upload(name){
    if (this.data[name] != '' && this.data[name].indexOf('tmp')>0){
      ...
      // wx.uploadFile({
      //   url: 'https://picture-cr45mes.oss-cn-shenzhen.aliyuncs.com/img', // 仅为示例，非真实的接口地址
      ...
      wx.uploadFile({
        ...
        success(res) {
          ...
          if (red.code == 1) {
            ...
            if(name == 'cert'){
              _this.setData({
                cert: 'https://picture-cr45mes.oss-cn-shenzhen.aliyuncs.com/img/202212310747329.png'
                // cert: red.data.url
              })
            }else{
              _this.setData({
                stu_card: 'https://picture-cr45mes.oss-cn-shenzhen.aliyuncs.com/img/202212310747329.png'
                // stu_card: red.data.url
              })
            }
